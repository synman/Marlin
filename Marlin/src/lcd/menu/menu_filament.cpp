...
void menu_pause_option() {
  ...
  #if HAS_FILAMENT_SENSOR
    //���ϼ�����ŵ�״̬runout.filament_ran_out = 1 Ϊȱ�ϣ� 0Ϊ�Ĳ��Ѽ���
    const bool still_out = runout.filament_ran_out;  
    if (still_out)
      EDIT_ITEM(bool, MSG_RUNOUT_SENSOR, &runout.enabled, runout.reset);  //LCD12864�˵�ѡ���Ƿ������ϼ��
  #else
    constexpr bool still_out = false;
  #endif

  if (!still_out)  //~0 Ϊ�棬˵����ʱ�Ĳ��Ѿ�װ���ˣ���Ҫ�û�ȷ�ϣ��������ӡ
  {
