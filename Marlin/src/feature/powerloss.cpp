...
void PrintJobRecovery::resume() {
  ...
  gcode.process_subcommands_now_P(PSTR("G92.9E0")); // Reset E to 0
    ...
    //gcode.process_subcommands_now_P(PSTR("G1 Z0.05"));
    ...
    gcode.process_subcommands_now_P(PSTR("G28" TERN_(HOME_XY_ONLY, "XY"))); // No raise during G28
  ...
  gcode.process_subcommands_now_P(PSTR("M420 S0 Z0")); //20220326 modify
