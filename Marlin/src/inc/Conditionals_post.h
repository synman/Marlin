...
#if HAS_TEMPERATURE && ANY(HAS_LCD_MENU, DWIN_CREALITY_LCD, CREALITY_TOUCHSCREEN) //EITHER(HAS_LCD_MENU, DWIN_CREALITY_LCD, CREALITY_TOUCHSCREEN)
 ...
 */
  ...
  #define HAS_BUZZER 1
#endif
#if ANY(HAS_BEEPER, USE_MARLINUI_BUZZER, CREALITY_TOUCHSCREEN)
  #define HAS_SOUND 1
#endif
